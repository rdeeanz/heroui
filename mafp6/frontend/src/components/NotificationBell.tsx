  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      <button
        ...
        onClick={() => setBuka((v) => !v)}
        className="relative rounded-lg border border-default-200 bg-surface p-2 text-default-700 hover:bg-default-100"
      >
      ...
      {/* Panel notifikasi. */}
      {buka ? (
        <div className="absolute right-0 z-50 mt-2 w-80 rounded-xl border border-default-200 bg-surface shadow-lg">
